...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 14 Apr 2020 pada 08.06
...
('root', 'alatmusik', 'table', 'tubes_193040099', '');
...
('root', '[{\"db\":\"tubes_193040099\",\"table\":\"alatmusik\"},{\"db\":\"tubes_193040099\",\"table\":\"tubes_193040099\"},{\"db\":\"pw_193040099\",\"table\":\"tubes_193040099\"},{\"db\":\"pw_193040099\",\"table\":\"alatmusik\"}]');
...
('root', '2020-04-14 06:05:14', '{\"Console\\/Mode\":\"collapse\",\"lang\":\"id\"}');
...
--
CREATE DATABASE IF NOT EXISTS `tubes_193040099` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `tubes_193040099`;
